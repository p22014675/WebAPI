...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    try {
        ...
        if (favoriteManga.length === 0) {
            ...
            messageSpan.className = 'no-favorite-message';
            messageSpan.textContent = 'You have not favorited any manga yet. Add any manga to your favorite list and see your manga here!';
                                ...
                                <button class="bin-button">
                                    ...
                                    <svg class="bin-bottom" viewBox="0 0 33 39" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <mask id="path-1-inside-1_8_19" fill="white">
                                            <path d="M0 0H33V35C33 37.2091 31.2091 39 29 39H4C-0.418278 39 -4 37.2091 -4 35V0Z"></path>
                                        </mask>
